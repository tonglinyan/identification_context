...
def main():
    ...
    def preprocess_squad_batch_training(
        examples,
        question_column: str,
        context_column: str,
        answer_column: str,
        ...
        targets += [answer["text"][0] if q == q_d and len(answer["text"]) > 0 else " " for answer, q, q_d in zip(answers, questions, q_disordered)]
    ...
    def preprocess_function(examples):
        inputs, targets = preprocess_squad_batch_training(examples, question_column, context_column, answer_column)
    ...
    def preprocess_validation_function(examples):
        ...
        for i in range(len(model_inputs["input_ids"])):
            ...
            model_inputs["labels"].append(labels[sample_index])
